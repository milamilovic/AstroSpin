...
public class SphereScript : MonoBehaviour
{
    ...
    {
        Debug.Log("Collision detected by planet");
        ...
        if(collision.gameObject.name == "Astronaut")
        {
            ...
            astronaut.GetComponent<AstronautMove>().jumpDirection = UnityEngine.Vector3.zero;
            Destroy(astronaut.GetComponent<Rigidbody2D>());
            astronaut.GetComponent<AstronautMove>().setParent(gameObject);
